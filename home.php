...
<div class="col-lg bg-light">
    <div class="card-body card-background">
        ...
        <p class="card-text mt-3" style="font-family: 'Barlow Condensed', sans-serif; font-size: 15px;">Ingin tahu
            perkembangan gaji Anda? Bersama kami, pantau terus perkembangan karier
            anda!
