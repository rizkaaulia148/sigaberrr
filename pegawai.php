            ...
            foreach ($result as $row) {
                ...
                <div class="modal fade" id="ModalLihatPegawai<?php echo $row['NIP'] ?>" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Detail data pegawai BPS Kota Lhokseumawe
                                </h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                <input disabled type="number" class="form-control" id="floatingInput"
                                                    placeholder="NIP pegawai" name="NIP" value="<?php echo $row['NIP'] ?>">
                                                <label for="floatingInput">NIP</label>
                                                <div class="invalid-feedback">Masukkan NIP</div>
                                            </div>
                                            <div class="form-floating mb-3">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input disabled type="text" class="form-control" id="floatingGaji"
                                                    placeholder="Gaji pegawai (Rp)" name="GajiTerkini"
                                                    value="<?php echo $row['GajiTerkini'] ?>">
                                                <label for="floatingGaji">Gaji Terkini (Rp)</label>
                                                <div class="invalid-feedback">Masukkan Gaji Terkini</div>
                                            </div>
                                            <div class="form-floating mb-3">
                        ...
                        <tbody>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['GajiTerkini'] ?></td>
